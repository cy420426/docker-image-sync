...
| 39 | ghcr.io/apache/flink-kubernetes-operator |  | `docker pull ghcr.io/cy420426/flink-kubernetes-operator` | [flink-kubernetes-operator.yaml](https://github.com/cy420426/docker-image-sync/blob/main/docker-compose/flink-kubernetes-operator.yaml) |
